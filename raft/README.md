...
A simple example application, _raftexample_, is also available to help illustrate how to use this package in practice: https://github.com/ambition9186/etcd/tree/master/contrib/raftexample
...
- [etcd](https://github.com/ambition9186/etcd) A distributed reliable key-value store
