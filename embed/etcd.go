...
import (
	...
	"github.com/ambition9186/etcd/etcdserver/api/v2v3"
	"github.com/ambition9186/etcd/etcdserver/api/v3client"
	"github.com/ambition9186/etcd/etcdserver/api/v3rpc"
	"github.com/ambition9186/etcd/pkg/cors"
	"github.com/ambition9186/etcd/pkg/debugutil"
	runtimeutil "github.com/ambition9186/etcd/pkg/runtime"
...
var plog = capnslog.NewPackageLogger("github.com/ambition9186/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://github.com/ambition9186/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
