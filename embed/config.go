...
import (
	...
	"github.com/ambition9186/etcd/pkg/netutil"
	"github.com/ambition9186/etcd/pkg/srv"
...
type Config struct {
	...
	//
	// See https://github.com/ambition9186/etcd/issues/9333 for more detail.
...
func (cfg *Config) SetupLogging() {
	...
	if cfg.LogPkgLevels != "" {
		repoLog := capnslog.MustRepoLogger("github.com/ambition9186/etcd")
