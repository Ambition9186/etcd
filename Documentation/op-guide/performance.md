...
Benchmarking etcd performance can be done with the [benchmark](https://github.com/ambition9186/etcd/tree/master/tools/benchmark) CLI tool included with etcd.
